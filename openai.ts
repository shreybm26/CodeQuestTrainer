...
function getAnalysisFallback(question: string, userAnswer: string): {
  ...
  if (correctness < 50) {
    ...
    improvementTips = [
      "Include specific examples to illustrate your understanding of key concepts.",
      "Discuss the time and space complexity of your solution.",
      "Structure your answer more clearly with an introduction, approach, and conclusion."
    ];
  } else if (correctness < 70) {
    feedback = "Your answer demonstrates good understanding of the core concepts, but could be more comprehensive.";
    improvementTips = [
      "Consider alternative approaches and their trade-offs.",
      "Add more specific technical details to show deeper understanding.",
      "Be more explicit about the efficiency of your solution."
    ];
  } else {
    feedback = "Your answer is quite strong and shows good technical understanding of the topic.";
    improvementTips = [
      "Consider edge cases that might challenge your solution.",
      "Discuss potential optimizations for your approach.",
      "Connect this topic to related concepts to show broader understanding."
    ];
  }
